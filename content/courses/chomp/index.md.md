...
What about the number of boards that fit in a given $m\times n$ rectangle? This problem is even easier; the number of positions $p$ such that $\operatorname{height}(p)=m$ and $\operatorname{width}(p)=n$ is just the number of ways to make a list of decreasing integers
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2MDAwMTQ2XX0=
-->