...
But what if we wanted to represent smaller or larger numbers? We'd need a different denominator or a larger integer type. It becomes impractical fast; a $64$-bit system like this one would not be able to store both $10^{10}$ and its reciprocal $10^{-10}$. And the larger the size, the more inefficient to compute.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTkzMDY3NDQsLTMwODE4NzE2NSw2OD
Y2OTUxOTRdfQ==
-->